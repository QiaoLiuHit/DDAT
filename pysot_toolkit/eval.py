...
parser.add_argument('--dataset', '-d', type=str, default='LSOTB-TIR',
                    help='dataset name')
...
def main():
    ...
    #                                      'testing_dataset'))
    root = '/media/qiao/dataset/TrackingBenchmark'
            ...
            for attr, videos in dataset.attr.items():
                if attr == 'ALL':
                    draw_success_precision(success_ret,
                                       ...
                                       attr=attr,
                                       precision_ret=precision_ret)
    elif args.dataset in ['VOT2016', 'VOT2017', 'VOT2018', 'VOT2019', 'VOT-TIR16']:
