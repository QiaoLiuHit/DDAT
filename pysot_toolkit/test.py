...
def main():
    for i in range(1, 51):
        # load config
        dataset_root = '/media/qiao/dataset/TrackingBenchmark/LSOTB-TIR' #Absolute path of the dataset
        # net_path = '/media/qiao/code/TransT/pytracking/networks/transt.pth' #Absolute path of the model
        net_path = '/media/qiao/code/TransT/checkpoints/ltr/transt/transt/TransT_ep' + str(i).rjust(4, '0') + '.pth.tar'
        # create model
        ...
        total_lost = 0
        if args.dataset in ['VOT2016', 'VOT2018', 'VOT2019','VOT-TIR16']:
            # restart tracking
            for v_idx, video in enumerate(dataset):
                ...
                # save results
                video_path = os.path.join('results', args.dataset, model_name + 'ep_' + str(i).rjust(4, '0'),
                        'baseline', video.name)
            ...
            for v_idx, video in enumerate(dataset):
                ...
                if 'VOT2018-LT' == args.dataset:
                    ...
                    model_path = os.path.join('results', args.dataset, model_name + 'ep_' + str(i).rjust(4, '0'))
