...
class LTRTrainer(BaseTrainer):
    ...
    def cycle_dataset(self, loader):
        ...
        self.actor.train(loader[0].training)#[0]只对rgb
        ...
        # for i, data in enumerate(zip(loader[0], cycle(loader[1]))):
        for i, data in enumerate(zip(loader[0], loader[1])):#enumerate(loader[1] , 1):##原本从1开始
            if self.move_data_to_gpu:
                # data.to(self.device)
                data[0].to(self.device)
                data[1].to(self.device)

            data[0]['epoch'] = self.epoch #[0]只对rgb
            data[0]['settings'] = self.settings
            ...
            # update statistics
            batch_size = data[0]['search_images'].shape[loader[0].stack_dim]
            self._update_stats(stats, batch_size, loader[0])
    ...
    def train_epoch(self):
        ...
        self.cycle_dataset(self.loaders)
